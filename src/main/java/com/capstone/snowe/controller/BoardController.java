...
public class BoardController {
    ...
    * */
    ...
    public ResponseEntity<List<?>> fileAdd(@RequestPart(value="image", required = false) MultipartFile[] files) throws Exception {
        ...
        logger.info("파일이 존재합니다 " + Arrays.toString(files));
